  ...
  return (
    <div className="flex flex-col bg-white text-center w-96 p-8 rounded-3xl mt-32">
      ...
      <div className="flex flex-col relative -mt-40">
        <h1 className="mt-4 mb-3 font-semibold text-3xl">Marco Vilchis</h1>
        ...
        <div className="flex flex-col bg-gray-100 p-7 rounded-2xl">
          <div className="flex py-2.5 border-b border-gray-300 dark:border-l-gray-700">
            ...
            <div className="text-left ml-2.5">
              <p className="text-xs text-gray-500 dark:text-gray-600">Phone</p>
              <p className="dark-text-white break-all">+52 314 109 7185</p>
            </div>
          </div>
          <div className="flex py-2.5 border-b border-gray-300 dark:border-l-gray-700">
            <span className="flex-shrink-0 bg-white dark:bg-black text-pink-600 text-3xl shadow-md rounded-md p-1.5">
            ...
            <div className="text-left ml-2.5">
              ...
              <p className="dark-text-white break-all">Colima, México</p>
            </div>
          </div>
          <div className="flex py-2.5 border-b border-gray-300 dark:border-l-gray-700">
            <span className="flex-shrink-0 bg-white dark:bg-black text-pink-600 text-3xl shadow-md rounded-md p-1.5">
            ...
            <div className="text-left ml-2.5">
              <p className="text-xs text-gray-500 dark:text-gray-600">E-mail</p>
          ...
          <div className="flex py-2.5 border-b border-gray-300 dark:border-l-gray-700">
            ...
            <div className="text-left ml-2.5">
              ...
              <p className="dark-text-white break-all">May 20,2000</p>
            </div>
          </div>
        </div>
        <Cv
